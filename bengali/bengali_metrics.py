...
def multi_task_macro_recall(true_graphemes: np.array, pred_graphemes: np.array,
    ...
    grapheme_recall = recall_score(true_graphemes, pred_graphemes, 
                            labels=np.arange(n_grapheme), average='macro')
    vowel_recall = recall_score(true_vowels, pred_vowels, 
                            labels=np.arange(n_vowel), average='macro')
    consonant_recall = recall_score(true_consonants, pred_consonants, 
                            labels=np.arange(n_consonant), average='macro')
